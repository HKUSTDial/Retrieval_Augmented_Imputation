...
with LazyImport(message="Run 'pip install farm-haystack[inference]'") as torch_and_transformers_import:
    ...
    from src.modeling.model.adaptive_model import SiameseModel
    from src.modeling.training.base import Trainer
    from src.modeling.data_handler.data_silo import DataSilo

    from haystack.modeling.model.language_model import DPREncoder
